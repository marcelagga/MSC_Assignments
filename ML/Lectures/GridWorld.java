 ...
 *
 * This version uses simultaneous updates, as shown in AIMA 3ed Figure 17.4 p653. 
 */

public class GridWorld 
{
	// General settings
	private static double Ra = -0.04;         // reward in non-terminal states (used to initialise r[][])
	...
	public static void main(String[] args)
	{
		...
		R[0][3] =  1;  // positive sink state
		R[1][3] = -1;  // negative sink state
